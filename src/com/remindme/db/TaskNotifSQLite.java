...
*/
	...
	public ArrayList<RemindTask> monthlyEventsBetweenDates(Date day,
			Date endOfDay, Integer dayOfMonth) {
		this.open();
		...
		//queryBuilder.appendWhere(" AND "+NotificationSQLite.DATABASE_TABLE+"."+NotificationSQLite.KEY_ROWID + "=NULL");
		//queryBuilder.appendWhere(" AND "+NotificationSQLite.DATABASE_TABLE+"."+NotificationSQLite.KEY_DATE + "<=" + endDate.getTime());
	...
	public ArrayList<RemindTask> yearlyEventsBetweenDates(Date day,
			Date endOfDay, Integer dayOfYear) {
		this.open();
