		...
		new Thread(new Runnable()
		{
			...
			public void run() 
			{
				Log.d("ServiceManagement", "Running");
				    ...
				    alarmManager.set(AlarmManager.RTC_WAKEUP, Calendar.getInstance().getTimeInMillis()+ 7200000+ sleepTime, pendingIntent);
				    Log.d("ServiceManagement", "Sleep for:" + new Date(sleepTime) +" /n til: "+ new Date(Calendar.getInstance().getTimeInMillis()+7200000 +sleepTime) );	        
	        ...
	        private void createNotificationTest(){
    	    	...
    	    	NotificationCompat.Builder mBuilder =
    	    			...
    	    			.setAutoCancel(true)
    	    	        .setSmallIcon(R.drawable.ic_notif)
    	    	        .setWhen(new Date(Calendar.getInstance().getTimeInMillis()+7200000).getTime())
