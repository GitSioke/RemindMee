...
public class RemindAllTaskActivity extends RemindActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		*/
        ...
        if (taskList.isEmpty()){
        	Toast.makeText(this, R.string.all_toastEmpty, Toast.LENGTH_LONG).show();
        }else{
	...
	private void displayTaskWithTextView(final ArrayList<RemindTask> taskList){
		...
		OnItemClickListener listener = new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position,
					long id) {
				// TODO 
				Intent intent = new Intent(RemindAllTaskActivity.this, RemindTaskActivity.class);
